...
const Menu = () => {
  ...
  const content = isLoading ? (<h2 className='absolute top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] text-4xl text-white bold my-12'>Loading...</h2>) : (<MenuGrid products={products} />)
  ...
  return (
    ...
    {
       error
         ? <h2 className='absolute top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] text-2xl text-white bold'>{error}</h2>
         : <>
