  ...
  return (
    <>
      ...
      <div>
        ...
        <Card className='fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-white w-4/5 h-4/5 min-h-[300px] rounded-3xl overflow-hidden z-30'>
          <div className="flex flex-col lg:flex-row justify-center items-center h-full">
            ...
            <form className="flex flex-col gap-y-4 justify-evenly items-center w-full h-full p-8" onSubmit={onAddToCart}>
              ...
              <div className='grid grid-cols-3 text-center'>
                ...
                <h4>8 slices</h4>
                <h4>12 slices</h4>
                <button className='border-2 border-black p-4 bg-gray-200 rounded-b-lg focus:bg-slate-800 focus:text-white hover:bg-gray-400' onClick={(e) => e.preventDefault()}>Small</button>
                <button className='border-2 border-black p-4 bg-gray-200 rounded-b-lg focus:bg-slate-800 focus:text-white hover:bg-gray-400' onClick={(e) => e.preventDefault()}>Medium</button>
                <button className='border-2 border-black p-4 bg-gray-200 rounded-b-lg focus:bg-slate-800 focus:text-white hover:bg-gray-400' onClick={(e) => e.preventDefault()}>Jumbo</button>
              </div>

              <h2 className='text-xl lg:text-2xl font-bold text-center'>How many would you like to order?</h2>
              <div className='flex w-full justify-center'>
                <input className='border-2 border-black p-2 w-2/5' type="number" name="amount" id="amount" onChange={onChangeAmountHandler} value={amount} min={1} max={20}/>
